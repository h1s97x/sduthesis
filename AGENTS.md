...
| `build.yml` | 构建 PDF 包（main.pdf artifact，TeX Live 2024/2025 双版本矩阵） | push main / 手动 |
...
- **版本兼容性**：PR 阶段 lint/regression 用单版本（2025）提速；旧 TeX Live 兼容性由 `build.yml` 的 2024/2025 矩阵在 main 分支兜底。
