...
% 定义配置键
\keys_define:nn { sdu } {
  title .code:n = \cs_set:Nn \__sdu_title:n { ##1 },
  author .code:n = \cs_set:Nn \__sdu_author:n { ##1 },
  studentId .code:n = \cs_set:Nn \__sdu_studentid:n { ##1 },
  school .code:n = \cs_set:Nn \__sdu_school:n { ##1 },
  major .code:n = \cs_set:Nn \__sdu_major:n { ##1 },
  supervisor .code:n = \cs_set:Nn \__sdu_supervisor:n { ##1 },
}
