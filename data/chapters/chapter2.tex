...
\begin{figure}[htbp]
    \centering
    \subfloat[最大池化]{
        \includegraphics[width=0.45\textwidth]{figures/maxpooling.png}
    }
    \subfloat[平均池化]{
        \includegraphics[width=0.45\textwidth]{figures/avgpooling.png}
    }
    \caption{池化操作示意图}
    \label{fig:pooling}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/resblock.png}
    \caption{残差块结构}
    \label{fig:resblock}
\end{figure}
